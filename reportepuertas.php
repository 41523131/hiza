            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="votofiltro.php">Voto Familiar</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Reporte Puertas</h1>
                    <p class="mb-4"></p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="reporte4.php" method="POST" class="form-inline my-2 my-lg-0 sclass">

                        <label class="mr-sm-2" for="inlineFormCustomSelect">Municipio:</label>
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="municipio" required>
                            <option selected></option>
                            <option value="58">58</option>

                        </select>

                        <label class="mr-sm-2" for="inlineFormCustomSelect">Distrito Federal:</label>
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="distrito">
                            <option selected></option>
                        ...
                        <label class="mr-sm-2" for="inlineFormCustomSelect">Seccion:</label>
                        <input class="form-control mr-sm-2" type="text" name="seccion" placeholder="Seccion"
                        maxlength="10">
                        <br>

                        <label class="mr-sm-2" for="inlineFormCustomSelect">Manzana:</label>
                        <input class="form-control mr-sm-2" type="text" name="seccion" placeholder="Seccion"
                        maxlength="10">
                        <br>
