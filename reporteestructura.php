        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="card shadow mb-4">
                    <div class="card-header py-3" >
                        ...
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="mpio" required >
                        ...
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="distrito_federal">
                            <option selected></option>
                        ...
                        <label class="mr-sm-2" for="inlineFormCustomSelect">Distrito Local:</label>
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="distrito_local">
                            <option selected></option>
