        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Clasificacion Competitiva</h1>
                    <p class="mb-4"></p>
                                        ...
                                        <div class="col mr-2">
                                            <form >
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="inlineFormCustomSelect">Distrito Local:</label>
                                                        <select class="form-control " id="distrito_l" name="distrito_l">
                                                            <option selected></option>
                        ...
                        <div class="container-fluid">
                            ...
                            <?php
                                ...
                                if(isset($_REQUEST['generar_reporte'])){
                                    ...
                                    $mostrar=new hiza();
                                    $mostrar->conexion();
                                    $mostrar->tablaClasificacion($municipio, $distrito_f, $distrito_l);
                                }
                                }
