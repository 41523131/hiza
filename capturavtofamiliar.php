...
<!-- Divider -->
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header"></h6>
                        <a class="collapse-item" href="estructurafiltro.php">Estructura</a>
                        <a class="collapse-item" href="">Voto Familiar</a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseToqueUtilities"
                    aria-expanded="true" aria-controls="collapseToqueUtilities">
                     <i class="fas fa-fw fa-table"></i>
                    <span>Toque de Puertas</span>
                </a>
                <div id="collapseToqueUtilities " class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header"></h6>
                        <a class="collapse-item" href="">Punteo</a>
                        <a class="collapse-item" href="reportefiltro.php">Reporte</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Búsqueda de Simpatizante</h1>
                    <p class="mb-4"></p>
                        ...
                        <div class="card-header py-3" >
                            <div class="row">
                                ...
                                <div class="col floatStyle" >
                                    <a  class="btn btn-primary" href="agregarvtofamiliar.php">
