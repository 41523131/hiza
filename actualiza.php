        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
                    ...
                    $idPersona = $_REQUEST['id_registro'];



                    $conexion=mysqli_connect("localhost","root","","hiza");
                    $modificar=mysqli_query($conexion,"SELECT id, clave, nombre, paterno, materno, sexo, calle, v_int, ext, colonia, dtto, mpio, seccion, folio, tpoMnza, correo, distrito_local, ocupacion, seccion_trabajo, cargo, zona, manzana_asignada, redsocial_f, redsocial_w, redsocial_t, redsocial_i, telefono, t_celular, t_recados,distrito_federal FROM personasmasiva WHERE id = $idPersona  ")  or  die (mysqli_error($conexion));
                    

                    while ($list=mysqli_fetch_array($modificar)){
                ?>
                <div class="container-fluid">

                     <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Actualizar Registro : <span style=" font-size:20px;color: #2C67B7;"><?php echo $list['clave']; ?></span> </h1>
                    </div>
                                        ...
                                        <form method="post" onsubmit="return validarAddReg()">
                                          <div class="form-row">
                                            <div class="form-group col-md-6">
                                              ...
                                              <input name="inputCve" type="text" class="form-control" id="inputCve" placeholder="Apoyese de la INE" required="required" size="18" value="<?php echo $list['clave']; ?>" disabled="disabled">
                                              <div class="invalidInput" id="msg"></div>
                                            </div>
                                            <div class="form-group col-md-6">
                                              <label for="inputFolio">Folio</label>
                                              <input name="inputFolio" type="text" class="form-control" id="inputFolio" placeholder="" value="<?php echo $list['folio']; ?>">
                                          ...
                                          <div class="form-row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <input name="inputNom"  type="text" class="form-control UpperCase" id="inputNom" placeholder="" value="<?php echo $list['nombre']; ?>">
                                                <div class="invalidInput" id="msg2"></div>
                                            </div>
                                            <div class="form-group col-md-3">
                                                <label for="inputPat">Apellido Paterno</label>
                                                <input name="inputPat"  type="text" class="form-control UpperCase" id="inputPat" placeholder="" value="<?php echo $list['paterno']; ?>">
                                                <div class="invalidInput" id="msg3"></div>
                                            </div>
                                            <div class="form-group col-md-3">
                                                <label for="inputMat">Apellido Materno</label>
                                                <input name="inputMat"  type="text" class="form-control UpperCase" id="inputMat" placeholder="" value="<?php echo $list['materno']; ?>">
                                            ...
                                            <div class="form-group col-md-3 text-center" >
                                                ...
                                                <?php
                                                    if($list['sexo']=='H'){
                                                         echo '<input type="radio" name="sexo" value="H" id="sexo_h" checked="checked">
                                                            Hombre 
                                                        ...
                                                        <input type="radio" name="sexo" value="H" id="sexo_h">
                                                            Hombre 
                                                            <input type="radio" name="sexo" value="M" id="sexo_m" checked="checked">
                                                            Mujer';
                                                    }
                                          ...
                                          <div class="form-row">
                                                            ...
                                                            $seccion = $list['seccion'];
                                                             ...
                                                             $listaSecc=mysqli_query($conexion,"SELECT id inputSeccion, secc1 FROM seccion")  or die (mysqli_error($listaSecc));
                                                               while ($listSe=mysqli_fetch_array($listaSecc)){
                                                                   ...
                                                                   if($seccion==$listSe[0]){
                                                                    echo '<option value="'.$listSe[0].'" selected="selected">'.$listSe[1].'</option>';

                                                                    }else{
                                                                        echo '<option value="'.$listSe[0].'">'.$listSe[1].'</option>';
                                                                    }
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input  name="inputCalle" type="text" class="form-control UpperCase" id="inputCalle" value="<?php echo $list['calle']; ?>">
                                                <div class="invalidInput" id="msg6"></div>
                                            </div>
                                            <div class="form-group col-md-1">
                                                <label for="inputManzana" id="autoUpdate">N. Exterior</label>
                                                <input name="inputManzana" type="text" class="form-control" id="inputManzana" value="<?php echo $list['ext']; ?>">
                                                <div class="invalidInput" id="msg7"></div>
                                            </div>
                                            <div class="form-group col-md-1">
                                                <label for="inputLote" id="autoUpdate2">N. Interior</label>
                                                <input name="inputLote" type="text" class="form-control" id="inputLote" value="<?php echo $list['v_int']; ?>">
                                                ...
                                                <div class="custom-control custom-switch">
                                                  <?php
                                                    if($list['tpoMnza']==1){
                                                        ...
                                                        echo '<input type="checkbox"  name="tpoMnza" class="custom-control-input" id="customSwitch1" checked="checked">';
                                                    }
                                                    else {
                                                        echo '<input type="checkbox"  name="tpoMnza" class="custom-control-input" id="customSwitch1">';   
                                                    }
                                               ...
                                               <div class="form-group col-md-3">
                                                    <label  for="inputColonia">Colonia</label>
                                                       <select id="inputColonia" name="inputColonia" class="form-control selectpicker">
                                                         ...
                                                         $colonia = $list['colonia'];

                                                         $listaCol=mysqli_query($conexion,"SELECT idColonia, nombreColonia FROM colonia WHERE idColonia = '$colonia' ")  or die (mysqli_error($listaCol));
                                                               while ($listaCla=mysqli_fetch_array($listaCol)){
                                                                echo '<option value="'.$listaCla[0].'" selected="selected">'.$listaCla[1].'</option>';
                                                            }
                                                ...
                                                <label for="dtol2">Distrito local</label>
                                                        <select id="dtol2" name="dtol2" class="form-control selectpicker">
                                                         ...
                                                         <?php
                                                            ...
                                                            $listaDistritoPer=mysqli_query($conexion,"
                                                                SELECT id, distrito FROM distritos")  or 
                                                            die (mysqli_error($conexion));

                                                            while ($listaDP=mysqli_fetch_array($listaDistritoPer)){

                                                                if($listaDP[0]==$idDist){
                                                                    echo '<option value="'.$listaDP[0].'" selected="selected">'.$listaDP[1].'</option>';

                                                                }
                                                                else{ 
                                                                    echo '<option value="'.$listaDP[0].'">'.$listaDP[1].'</option>';
                                                                }
                                                        }
                                                        ?>
                                                    </select>
                                            ...
                                            <div class="form-group col-md-2">
                                              ...
                                              <input name="inputTelefono" type="text" class="form-control" id="inputTelefono" value="<?php echo $list['telefono']; ?>" required="required">
                                              <div class="invalidInput" id="msg9"></div>
                                              
                                            </div>
                                            <div class="form-group col-md-2">
                                              <label for="inputCelular">Celular</label>
                                              <input name="inputCelular" type="text" class="form-control" id="inputCelular" value="<?php echo $list['t_celular']; ?>">
                                              <div class="invalidInput" id="msg11"></div>
                                              
                                            </div>
                                            <div class="form-group col-md-2">
                                              <label for="inputRecado">Telefono Recados</label>
                                              <input name="inputRecado" type="text" class="form-control" id="inputRecado" value="<?php echo $list['t_recados']; ?>">
                                             ...
                                             <div class="form-group col-md-4">
                                                    ...
                                                    if(isset($list['ocupacion'])){
                                                        $idOcu = $list['ocupacion'];
                                                    }
                                                    else{
                                                        $idOcu = '0';
                                                    }
                                                   
                                                    $txtValCargo = 'selected ="selected"';
                                                   
                                                        

                                                    ?>
                                                    <option <?php if("0"==$idOcu){ echo 'selected ="selected"';}  ?> ></option>
                                                    <option value="1" <?php if("1"==$idOcu){ echo 'selected ="selected"';}  ?> >Ama de Casa</option>
                                                    <option value="2" <?php if("2"==$idOcu){ echo 'selected ="selected"';}  ?>> Campesino/Agricultor</option>
                                                    <option value="3" <?php if("3"==$idOcu) { echo 'selected ="selected"';} ?>> Ejidatario</option>
                                                    <option value="4" <?php if("4"==$idOcu) { echo 'selected ="selected"';} ?>> Empleado</option>
                                                    <option value="5" <?php if("5"==$idOcu){ echo 'selected ="selected"';}  ?> >Empleado de Gobierno</option>
                                                    <option value="6" <?php if("6"==$idOcu){ echo 'selected ="selected"';}  ?> >Empresario</option>
                                                    <option value="7" <?php if("7"==$idOcu){ echo 'selected ="selected"';}  ?> >Estudiante</option>
                                                    <option value="8" <?php if("8"==$idOcu){ echo 'selected ="selected"';}  ?> >Jubilado/Pensionado</option>
                                                    <option value="9" <?php if("9"==$idOcu){ echo 'selected ="selected"';}  ?> >Obrero</option>
                                                    <option value="10" <?php if("10"==$idOcu){ echo 'selected ="selected"';}  ?> >Profesionista libre/Freelance</option>                                
                                                    <option value="11" <?php if("11"==$idOcu){ echo 'selected ="selected"';}  ?>>Trabajador por su cuenta</option>
                                                    <option value="12" <?php if("12"==$idOcu){ echo 'selected ="selected"';}  ?>>Otro</option>
                                                </select>
                                          ...
                                          <div class="form-row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <select name="cargo" class="custom-select " id="cargo" onchange="oculta()">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $listaCargo=mysqli_query($conexion,"
                                                            SELECT id, cargo FROM cargo")  or 
                                                            die (mysqli_error($conexion));

                                                            while ($listaCar=mysqli_fetch_array($listaCargo)){
                                                                if($listaCar[0]==$cargo){
                                                                    echo '<option value="'.$listaCar[0].'" selected="selected">'.$listaCar[1].'</option>';
                                                                }
                                                                else{
                                                                    echo '<option value="'.$listaCar[0].'">'.$listaCar[1].'</option>';
                                                                }
                                                        }
                                                    ?> 
                                                </select>
                                            ...
                                            <!--- Se oculta la zona ---->
                                                 <div class="form-group col-md-1" id="divzona" name="divzona">
                                                  ...
                                                  <input name="zona" type="number" size="20" class="form-control" id="zona" value="<?php echo $list['zona']; ?>">
                                                </div>
                                            ...
                                            <div class="form-group col-md-2" id="divsecc1" name="divsecc1">
                                              <label for="secc1">Sección de Trabajo</label>
                                                ...
                                                <select name="secc1" id="secc1" class="form-control selectpicker" data-show-subtext="true" data-live-search="true" onchange="showHint(this.value)">
                                                    <option selected></option>
                                                    <?php 
                                                    $lSseccion = $list['seccion_trabajo'];

                                                        $laSeccionlist=mysqli_query($conexion,"
                                                                SELECT id, secc1 FROM seccion ")  or 
                                                            die (mysqli_error($conexion));

                                                            while ($laSeccionl=mysqli_fetch_array($laSeccionlist)){
                                                            if($laSeccionl[0]==$lSseccion){
                                                                echo '<option value="'.$laSeccionl[0].'" selected="selected">'.$laSeccionl[1].'</option>';
                                                            }
                                                            else{
                                                                echo '<option value="'.$laSeccionl[0].'">'.$laSeccionl[1].'</option>';    
                                                            }
                                            ...
                                            <div class="form-group col-md-2" id="divsecc11">
                                              <label for="dtol1">Distrito Local</label>
                                               <select id="dtol1" name="dtol1" class="form-control selectpicker">
                                                ...
                                                <option selected></option>
                                                        <?php
                                                            $dlocal = $list['distrito_local'];

                                                            $dlocalTxt = 'selected="selected"';


                                                             
                                                             $dlcallList=mysqli_query($conexion,"
                                                                SELECT id, distrito FROM distritos WHERE nombre = 'DISTRITO LOCALES'")  or 
                                                            die (mysqli_error($conexion));

                                                            while ($dlcall=mysqli_fetch_array($dlcallList)){
                                                                if($dlcall[0]==$dlocal){
                                                                    echo '<option value="'.$dlcall[0].'" selected="selected" >'.$dlcall[1].'</option>';
                                                                }
                                                                else{
                                                                    echo '<option value="'.$dlcall[0].'">'.$dlcall[1].'</option>';
                                                                }
                                               ...
                                               <select id="dtof1" name="dtof1" class="form-control selectpicker">
                                                ...
                                                <option selected></option>
                                                         <?php
                                                            ...
                                                            $dfederal = $list['distrito_federal'];


                                                             
                                                             $dlcallListDF=mysqli_query($conexion,"
                                                                SELECT id, distrito FROM distritos WHERE nombre = 'DISTRITO FEDERALES'")  or 
                                                            die (mysqli_error($conexion));

                                                            while ($dlcall=mysqli_fetch_array($dlcallListDF)){
                                                                if($dlcall[0]==$dfederal){
                                                                    echo '<option value="'.$dlcall[0].'" selected="selected" >'.$dlcall[1].'</option>';
                                                                }
                                                                else{
                                                                    echo '<option value="'.$dlcall[0].'">'.$dlcall[1].'</option>';
                                            ...
                                            <div class="form-group col-md-2" id="divsecc12">
                                             ...
                                             <div class="form-row">
                                                <div class="form-group col-md-2" id="divmza1">
                                                    ...
                                                    <input name="mza1" type="number" size="20" class="form-control" id="mza1"  value="<?php echo $list['manzana_asignada']; ?>">
                                                </div>
                                            </div>
                                          ...
                                          <div class="form-row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input name="inputCorreo"  type="text" class="form-control custom-control-label validate toLowerCase" id="inputCorreo" aria-describedby="emailHelp" placeholder="example@gmail.com" value="<?php echo $list['correo']; ?>">
                                             ...
                                             <div class="form-group col-md-9">
                                                ...
                                                <div class="form-check col-md-5">
                                                    <?php  
                                                        $checkRedf = $list['redsocial_f'];
                                                        

                                                        if(isset($checkRedf)) {
                                                            echo 
                                                            '<input class="form-check-input id-check" type="checkbox"  name="face" checked="checked">
                                                                <input type="newquantity[]" class="myinput form-control" name="inputFace"  placeholder="Facebook" name="inputFace" value="'.$checkRedf.'">';

                                                        }
                                                        else{
                                                            echo 
                                                            '<input class="form-check-input id-check" type="checkbox"  name="face" >
                                                                <input type="newquantity[]" class="myinput form-control" name="inputFace"  placeholder="Facebook" name="inputFace" disabled="disabled">';
                                              ...
                                              <br>
                                                  <div class="form-check col-md-5">
                                                    ...
                                                    <?php  
                                                        $checkRedw = $list['redsocial_w'];

                                                        if(isset($checkRedw)) {
                                                            echo 
                                                            '<input class="form-check-input id-check" type="checkbox" name="whats" checked="checked" >
                                                  <input type="newquantity[]" class="myinput form-control" name="inputWhats"  placeholder="Whatsapp" name="inputWhats" value="'.$checkRedw.'">';
                                                ...
                                                <div class="form-check col-md-5">
                                                    <?php  
                                                        $checkRedwT = $list['redsocial_t'];

                                                        if(isset($checkRedwT)) {
                                                            echo 
                                                            '<input class="form-check-input id-check" type="checkbox" name="twit" checked="checked">
                                                  <input type="newquantity[]" class="myinput form-control" name="inputTwit" placeholder="Twitter" name="inputTwit" value="'.$checkRedwT.'">';
                                                ...
                                                <div class="form-check col-md-5">
                                                    <?php  
                                                        $checkRedwI = $list['redsocial_i'];

                                                        if(isset($checkRedwI)) {
                                                            echo 
                                                            '<input class="form-check-input id-check" type="checkbox"  name="ins" checked="checked">
                                                   <input type="newquantity[]" class="myinput form-control" name="inpuIns"   placeholder="Instagram"
                                                   name="inputIns" name="inputTwit" value="'.$checkRedwI.'">';
                                          ...
                                          <button type="submit" class="btn btn-primary" name="boton" value="Actualizar">Actualizar</button>
                                        </form>
